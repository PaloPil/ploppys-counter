...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const raison = interaction.options.getString('raison') || 'Pas de raison. ¯\\_(ツ)_/¯';

    // Execution

    const embed = new EmbedBuilder()
      .setTitle(`L'utilisateur *\`${target.tag}\`* a été banni pour la raison suivante :`)
